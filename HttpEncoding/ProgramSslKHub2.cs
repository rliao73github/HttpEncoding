...
namespace HttpEncoding
{
    ...
    public class SslTcpClientKHub2
    {
        ...
        static string ReadMessage(SslStream sslStream, TcpClient tc)
        {
            ...
            // "<EOF>" marker.
            byte[] buffer = new byte[256]; //-- new byte[2048];
        ...
        public static void Main_KHUB2(string[] args)
        {
