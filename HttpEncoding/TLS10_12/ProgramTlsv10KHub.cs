...
namespace HttpEncoding
{
    ...
    ///--
    ///-- TLSv11: first data packet arrived in 481 bytes, second in 12 bytes
    ///-- TLSv10: first data packet arrived in 1 bytes, second in 480, third in 12 bytes 
    ...
    ///-- 
    public class SslTcpClientKHubTls10
    {
        ...
        public static void Main_TLS10(string[] args)
        {
