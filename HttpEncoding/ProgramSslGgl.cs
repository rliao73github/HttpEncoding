...
namespace HttpEncoding
{
    ...
    public class SslTcpClientGgl
    {
        ...
        public static void RunClient(string machineName, string serverName)
        {
            ...
            string requestMessage = "GET /echo/test HTTP/1.1" +
                "\r\nHost: www.google.com" +
                "\r\nAccept: */*" +
                "\r\nConnection: close\r\n\r\n";
        ...
        public static void Main_GOOGLE(string[] args)
        {
            ...
            machineName = "www.google.com";
            serverCertificateName = "www.google.com";
