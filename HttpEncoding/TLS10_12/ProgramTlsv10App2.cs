...
namespace HttpEncoding
{
    ...
    public class SslTcpClientApp2
    {
        ...
        public static void RunClient(string machineName, string serverName)
        {
            ...
            try
            {
                //-- OK to use TLSv11 and TLSv12
                //-- NOT ok to use TLSv10, conn forcely closed by server
...
//"\r\nConnection: Close\r\n\r\n";
        ...
        public static void Main_APP2(string[] args)
        {
            ...
            machineName = "app2.kitchener.ca";
            serverCertificateName = "app2.kitchener.ca";
