...
namespace HttpEncoding
{
    ...
    public class SslTcpClientDemo
    {
        ...
        public static void RunClient(string machineName, string serverName)
        {
            ...
            string requestMessage = "GET /demo/h2_demo_frame.html HTTP/1.1\r\n" +
        ...
        public static void Main_DEMO(string[] args)
        {
            ...
            machineName = "http2.akamai.com";
            serverCertificateName = "http2.akamai.com";
