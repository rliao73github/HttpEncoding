...
namespace HttpEncoding
{
    ...
    public class SslTcpClientBin443
    {
        ...
        public static void RunClient(string machineName, string serverName)
        {
            ...
            string requestMessage = "POST /echo/post/json HTTP/1.1" +
            "\r\nHost: reqbin.com" +
            ...
            //-- 200 OK true 
            //string requestMessage =  "GET /echo/get/json HTTP/1.1" +
            //"\r\nHost:  reqbin.com" +
            //"\r\nAccept: application/json" +
            //"\r\nConnection: close\r\n\r\n";
        ...
        public static void TES_TMain(string[] args)
        {
            ...
            machineName = "reqbin.com";
            serverCertificateName = "reqbin.com";
