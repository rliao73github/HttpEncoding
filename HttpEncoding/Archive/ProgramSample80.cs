...
public class GetSocketPort80Sample
{
    ...
    private static string SocketSendReceive(string server, int port)
    {
        ...
        string request = "GET /api/v1/employee/2  HTTP/1.1" + 
            "\r\nHost: " + server +
    ...
    public static void TEST_Main(string[] args)
    {
        ...
        //-- NOT WORKING
        host = "dummy.restapiexample.com"; //-- socket connected but no data received
