...
namespace HttpEncoding
{
    ...
    public class SslTcpClientAmanda
    {
        ...
        public static void RunClient(string machineName, string serverName)
        {
            ...
            string requestMessage = "GET /portal/sfjsp?interviewID=SignOn HTTP/1.1\r\n" +
            "Host: onlinepermits.kitchener.ca\r\n" +
        ...
        public static void Main_AMANDA(string[] args)
        {
            ...
            machineName = "onlinepermits.kitchener.ca";
            serverCertificateName = "onlinepermits.kitchener.ca";
